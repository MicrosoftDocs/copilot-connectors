...
Adjust these schedules to fit your data refresh needs. For more information, see [Guidelines for crawl settings](deployment-overview.md#guidelines-for-crawl-settings).
