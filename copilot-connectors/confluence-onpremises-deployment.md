...
- In the **Manage apps** menu in Confluence, verify that the **Confluence Mobile Web Plugin** is enabled. The plugin is active by default; reenable it if it's deactivated.
