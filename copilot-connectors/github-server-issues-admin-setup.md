...
- **For custom GitHub app (on behalf of user) authentication:** On the GitHub app **General** page, select **Generate a new client secret** to generate and copy the **client secret**.
