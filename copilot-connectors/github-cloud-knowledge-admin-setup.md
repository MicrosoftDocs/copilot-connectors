---
title: Set up the GitHub service for GitHub Cloud Knowledge Microsoft 365 Copilot connector ingestion
...
5. Configure the app:
    ...
    :::image type="content" source="./media/github-cloud-knowledge-admin-setup/callback-url.png" alt-text="Screenshot of GitHub App configuration form showing app name, homepage URL, and callback URL fields.":::
...
8. Under **Where can this GitHub App be installed**, select **Any account**, and then select **Create GitHub App**.
    ...
    :::image type="content" source="./media/github-cloud-knowledge-admin-setup/create-github-app.png" alt-text="Screenshot of GitHub App permissions and installation settings section.":::
...
2. Select the organization where you want the app to be installed.
    ...
    :::image type="content" source="./media/github-cloud-knowledge-admin-setup/install-authorize.png" alt-text="Screenshot of GitHub App installation page showing organization selection.":::
...
> [Deploy the GitHub Knowledge connector](github-cloud-knowledge-deployment.md)