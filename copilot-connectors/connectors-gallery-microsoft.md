---
title: "Microsoft-built Microsoft 365 Copilot connectors gallery"
ms.author: danielabo
author: danielabom
manager: calvind
ms.audience: Admin
...
ms.date: 03/12/2026
---
# Microsoft-built Microsoft 365 Copilot connectors gallery
...
| GitLab Issues Server | Microsoft | Lets developers track and manage projects using GitLab Server. | [GitLab Issues Server connector](gitlab-issues-server-overview.md) |
...
| ServiceNow Catalog | Microsoft | Allows your organization to find Catalog items to order from the ServiceNow instance. Supports item-level user criteria permissions too. | [ServiceNow Catalog Copilot connector](servicenow-catalog-overview.md) |
| ServiceNow Knowledge | Microsoft | Allows your organization to search your ServiceNow instance for knowledge-based articles along with user criteria permissions. | [ServiceNow Knowledge Copilot connector](servicenow-knowledge-overview.md) |
