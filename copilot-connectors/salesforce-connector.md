...
- The Salesforce Copilot connector doesn't currently support Apex-based, territory-based sharing and sharing using personal groups from Salesforce.
...
1. This consumer key and secret is used as the client ID and the client secret when you configure the connection settings for your Salesforce Copilot connector in the Microsoft 365 admin portal. Acquire this information as follows:
