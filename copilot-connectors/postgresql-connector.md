...
>[!NOTE]
> If you previously installed the GCA, ensure it's updated to version 3.1.5.0 or later.
...
The table summarizes the SQL data types that are supported in the PostgreSQL Copilot connector. The table also summarizes the indexing data type for the supported SQL data type. To learn more about Microsoft 365 Copilot connectors supported data types for indexing, refer documentation on [property resource types](/graph/api/resources/externalconnectors-externalconnection).
