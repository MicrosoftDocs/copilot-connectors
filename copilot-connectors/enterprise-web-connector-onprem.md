---
ms.date: 10/08/2019
title: "Enterprise Websites on-premises connector"
ms.author: vivg
author: vivg
manager: harshkum
audience: Admin
...
2. Extract the files to the path: `C:\Windows\ServiceProfiles\GcaHostService\AppData\Local\Microsoft\GraphConnectorAgent\Tools\CustomPlaywright`.
   Finally, you should have the chrome.exe file in the following path: `C:\Windows\ServiceProfiles\GcaHostService\AppData\Local\Microsoft\GraphConnectorAgent\Tools\CustomPlaywright\chromium-1169\chrome-win\chrome.exe`
