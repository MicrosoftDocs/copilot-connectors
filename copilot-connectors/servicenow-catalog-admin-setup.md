...
The connector sends a POST request whose body specifies the users to evaluate (`users`) and the user criteria applied to the catalog items being indexed (`user_criteria`), both as arrays of sys_ids:
