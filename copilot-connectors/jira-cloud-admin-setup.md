...
For information about how to deploy the connector, see [Jira Cloud Copilot connector](jira-connector.md).
...
When you deploy the connector, you need the **client ID** and **client secret** for [OAuth 2.0 authentication](jira-connector.md#3-provide-authentication-type). To create an OAuth 2.0 app:
...
> [Deploy the Jira Cloud connector](jira-connector.md)