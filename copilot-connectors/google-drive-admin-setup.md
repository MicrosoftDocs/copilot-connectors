---
title: Set up the Google Workspace service for Google Drive Microsoft 365 Copilot connector ingestion
...
The Google Drive Copilot connector requires a service account key generated by a Google Cloud Platform console project. When you deploy the connector in the Microsoft 365 admin center, you need to [provide the service account key](google-drive-connector.md#4-service-account-key).
...
> [Deploy the Google Drive connector](/microsoftsearch/google-drive-connector)
