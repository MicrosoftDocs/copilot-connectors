...
To verify PagerDuty configuration information to help troubleshoot errors, see [Set up the PagerDuty Incidents connector](pagerduty-incidents-connector.md).
