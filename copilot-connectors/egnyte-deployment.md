...
For more information about display names and descriptions, see [Enhance Copilot discovery of connector content](/microsoftsearch/enhancing-microsoft-copilot-discovery-with-graph-connector-content).
...
> If you choose non-Microsoft Entra ID, provide a regular expression to map identities from email ID to UPN. For more information, see [Map your non-Microsoft Entra ID identities](/microsoftsearch/map-non-aad).
