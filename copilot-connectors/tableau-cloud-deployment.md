...
> [!Important]
> If you use Tableau Bridge for live connections to local databases, evaluate your infrastructure capacity before proceeding. The connector’s periodic full crawls can generate a high volume of concurrent queries, which might overload the CPU and memory resources of your on-premises database. To mitigate this risk:
