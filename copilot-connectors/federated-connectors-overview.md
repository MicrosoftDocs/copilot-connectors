...
- Bulk disable all federated connectors by using CLI commands, and selectively enable specific federated connectors in the Microsoft 365 admin center based on organizational policies and readiness.
