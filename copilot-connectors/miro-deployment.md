...
The sync interval determines how often your data syncs between the Miro data source and the index. The connector supports only full crawl refresh intervals. Adjust the default value as needed.
