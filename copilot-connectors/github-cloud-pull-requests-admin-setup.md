...
- **For custom GitHub app (on behalf of user) authentication:** On the **General** page of the GitHub app, select **Generate a new client secret** to generate and copy the **client secret**.
    ...
    :::image type="content" source="./media/github-cloud-pull-requests-admin-setup/github-app-credentials.png" alt-text="Screenshot of GitHub with Generate a new client secret highlighted." lightbox="./media/github-cloud-pull-requests-admin-setup/github-app-credentials.png":::
