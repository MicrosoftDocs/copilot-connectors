---
title: "Troubleshoot issues with the {connector name} connector"
ms.author: 
author: 
manager: 
ms.reviewer: 
...
description: "Find troubleshooting information for the {connector name} Microsoft 365 Copilot connector."
---

# Troubleshoot issues with the {connector name} connector
...
To verify {service name} configuration information to help troubleshoot errors, see [Set up the {service name} service for connector ingestion](confluence-cloud-admin-setup.md).}
